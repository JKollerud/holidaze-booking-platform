...
export default function DashboardPage() {
  ...
  const TABS: { key: Tab; label: string }[] = [
    ...
    ...(user.venueManager
      ? [{ key: 'venues' as Tab, label: 'Your venues' }]
      : []),
  ];
  ...
  return (
    <div>
      <section aria-label="Profile header">
        <div className="h-36 sm:h-56 w-full overflow-hidden bg-border">
          <img
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-end gap-4 -mt-12 sm:-mt-16 pb-4">
            <div className="shrink-0 w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-white bg-border overflow-hidden shadow-lg">
              {user.avatar?.url ? (
                <img
                  src={user.avatar.url}
            ...
            <div className="pb-2">
              <h1 className="font-heading text-lg sm:text-2xl font-extrabold text-text-primary">
                {user.name}
              </h1>
              ...
              <button
                ...
                className="btn-cta text-xs sm:text-sm px-3 sm:px-4 py-1.5 rounded-lg mt-2"
              >
          ...
          >
            {TABS.map((t) => (
              <button
                ...
                className={`font-body font-medium text-sm px-4 py-2.5 rounded-lg border transition-colors ${
                  tab === t.key
            ...
            {user.venueManager && (
              <button
                ...
                className="btn-cta text-sm px-4 py-2.5 rounded-lg ml-auto"
              >
                + Add venue
              </button>
            )}
          ...
          <div role="tabpanel" className="pb-12">
            {loading ? (
              ...
              <>
                ...
                {tab === 'favorites' && <Empty msg="Favorites coming soon." />}
